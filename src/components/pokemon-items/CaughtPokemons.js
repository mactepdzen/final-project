...
export default class CaughtPokemons extends React.Component {
    ...
    async componentDidMount() {
        ...
        let arrayOfCaughtPokemons = [];
        for (let item of result.data) {
            if (item.isCaught !== undefined) arrayOfCaughtPokemons.push(item);
        }
        this.setState({pokemon: arrayOfCaughtPokemons});
            ...
            <div>
                <div className='container'>
                    ...
                    <div className='btn-container'>
                        <button type='button' onClick={this.loadMore.bind(this)} className='btn-loadmore'>Load
                            more
                        </button>
                    </div>
                </div>
